<template>
  ...
  <div v-else-if="!productsData">Не удалось загрузить товар</div>
  <main class="content container" v-else>
    <div class="content__top">
      <ul class="breadcrumbs">
        <li class="breadcrumbs__item">
          <router-link tag="button" class="breadcrumbs__link" :to="{name:'main'}">
            Каталог
          </router-link>
        </li>
        <li class="breadcrumbs__item">
    ...
    <section class="item">
      <div class="item__pics pics">
        <div class="pics__wrapper">
          <img width="570" height="570" :src="product.image.file.url" :srcset="product.image.file.url" :alt="product.title">
        </div>
      ...
      <div class="item__info">
        ...
        <div class="item__form">
          <form class="form" action="#" method="POST" @submit.prevent="addToCart">
            <b class="item__price">
              {{ product.price | numberFormate }}
            </b>

            <fieldset class="form__block">
              <legend class="form__legend">Цвет:</legend>
           
              <BaseColor :colors="product.colors" :color-filter.sync="colorFilter"/>
            </fieldset>
            ...
            <div class="item__row">
              ...
              <AmoutProductControl :product-amount.sync="productAmount"/>
...
import AmoutProductControl from '@/components/AmoutProductControl'
...
export default {
    ...
    data(){
      return{
        ...
        colorFilter: this.product ? this.product.colors[0].id : 0,
        productAdded: false,
        productAddSending: false,
      }
    },
    components:{AmoutProductControl, BaseColor},
    computed:{
      product(){
